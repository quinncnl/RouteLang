...
public class Language extends LanguageRuntime {
  ...
  public static final String MODULE_REF = "cd8cd0fc-0f42-4bba-9454-613f52f5f8a7(ExtendedRoute)";
  public Language() {
  }
  @Override
  ...
  public SLanguageId getId() {
    return new SLanguageId(UUID.fromString("cd8cd0fc-0f42-4bba-9454-613f52f5f8a7"));
  }
  @Override
  protected String[] getExtendedLanguageIDs() {
    return new String[]{"jetbrains.mps.baseLanguage.regexp", "jetbrains.mps.lang.editor.editorTest", "jetbrains.mps.execution.util", "jetbrains.mps.baseLanguage", "RouteLang"};
  }
  @Override
  public Collection<TemplateModule> getGenerators() {
    return TemplateUtil.<TemplateModule>asCollection(TemplateUtil.createInterpretedGenerator(this, "8d196ec6-efcb-4bcc-9cd0-0f6920661b14(ExtendedRoute#1725408600645316202)"));
  }
  @Override
